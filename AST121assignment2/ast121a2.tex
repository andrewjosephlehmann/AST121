...
\textbar{I find this to be a surprising result mainly since this implies that the emission of the photon lay beyond the innermost stable orbit of the black hole. Hence, the photons that are emitted beyond a point where there is not enough angular momentum for them to escape the gravitational pull. In other words, the photons would have to orbit the black hole faster than the speed of light to escape. For a non-rotating black hole, the ISCO lies at a minimum of 3 Schwarzchild radius $\mathcal{R}_s$, and for a rotating black hole, the ISCO lies at a minimum of 4.5 Schwarzchild radii $\mathcal{R}_s$.}
\begin{center}
