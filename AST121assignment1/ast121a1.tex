...
\begin{gather*}
	\nu_{e} + u \rightarrow d + e^{-} \leftrightsquigarrow \textit{baryon number	} 0 + 1/3 \rightarrow 1/3 + 0 \leftrightsquigarrow \textit{charge	}  0 + 2/3 \rightarrow -1/3 + 0
\end{gather*}
\begin{gather*}
	\textit{spin	} 1/2 + 1/2 \rightarrow 1/2 + 1/2
\end{gather*}
\text{We can assume the weak interaction not to be possible since it does not conserve charge.}
